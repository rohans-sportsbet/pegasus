...
class LogWriter(object):
  ...
  def write(self, text_dict, i, interactive=False):
    if self._enable_logging:
      if interactive:
        logging.info("=" * 40 + " Start Abstractive Summary " + "=" * 40)
      ...
      if interactive:
        logging.info("=" * 40 + " Finish Abstractive Summary " + "=" * 40)
...
def interactive_text_eval(encoder,
                          features_iter,
                          model_dir,
                          global_step,
                          eval_tag,
  ...
  with LogWriter(additional_keys, model_dir, global_step, eval_tag,
    ...
    for i, features in enumerate(features_iter):
      ...
      log_writer.write(text_dict, i, interactive=True)
