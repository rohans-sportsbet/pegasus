...
def transformer_params(patterns, param_overrides):
  ...
  hparams.interactive_eval = functools.partial(
      text_eval.interactive_text_eval,
      hparams.encoder,
      num_reserved=pegasus_params.NUM_RESERVED_TOKENS)
...
@registry.register("reddit_tifu_transformer")
...
@registry.register("wikihow_transformer")
...
@registry.register("racing_transformer")
...
@registry.register("long_racing_transformer")
def racing_transformer(param_overrides):
  return transformer_params(
      {
          "train_pattern": "tfrecord:/home/ec2-user/SageMaker/pegasus/pegasus/data/testdata/racing_train.tfrecord",
